...
the data in 30s windows using SqlTransform, and writes the output to
...
def run(output_topic, pipeline_args):
  ...
  with beam.Pipeline(options=pipeline_options) as pipeline:
    _ = (
        ...
        | "30s fixed windows" >> beam.WindowInto(beam.window.FixedWindows(30))
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      help=(
          ...
          'projects/my-project/topics/Taxi_Summary), must be created prior to '
